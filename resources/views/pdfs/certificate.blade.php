...
<head>
    <meta charset="utf-8">
    <title>Transcript - Certificate</title>
    <style>
        body { font-family: DejaVu Sans, sans-serif; }
        .a4-container { margin-left:50px; page-break-after: always; }
        .a4-container:last-of-type { page-break-after: auto; }
        .header { padding-top: 12%; }
        .first_table { border-collapse: collapse; width: 100%; margin: 30px; }
        .module_area { height: 350px; }
        .module_table { justify-content: center; align-items: center; border-collapse: collapse; margin: 0 auto; }
        .footer { margin-top: 5; margin-left:30px; }
...
@foreach ($transcripts as $transcript)
    ...
    <div class="a4-container">
        ...
        <div class="footer">
            <p>Total credit points earned: {{ $totalCredit && $totalCredit > 0 ? rtrim(rtrim(number_format($totalCredit, 2, '.', ''), '0'), '.') : '40' }}</p>
            <p>Programme Duration: 6 months</p>
            <p style="font-size: xx-small; margin-top:45px;">Serial no: {{ $student->certificate_serial_number }}</p>
        </div>
    </div>
@endforeach
</body>
